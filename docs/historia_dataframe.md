...
- `historia_tramites_to_dataframe(xml_bytes: bytes, clean_text: bool = False, bcn_url: str = "", xml_url: str = "")`
...
- `historia_tramite_xmls_to_dataframe(xmls: Iterable[bytes], clean_text: bool = False, bcn_url: str = "", xml_urls: Optional[Iterable[str]] = None)`
  ...
  - Si recibe `xml_urls`, asigna a cada fila la URL de descarga correspondiente.
